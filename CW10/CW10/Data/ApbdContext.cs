...
public partial class ApbdContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdClient).HasName("PK__Client__C1961B33C266F034");
        ...
        {
            entity.HasKey(e => new { e.IdClient, e.IdTrip }).HasName("PK__Client_T__C823521E73CF8490");
        ...
        {
            entity.HasKey(e => e.IdCountry).HasName("PK__Country__F99F104D21F76660");
        ...
        {
            entity.HasKey(e => e.IdTrip).HasName("PK__Trip__9B5492D18356038A");
